...
namespace MASAPI.Migrations
{
    ...
    [Migration("20220526094220_cascade-delete")]
            ...
            modelBuilder.Entity("MASAPI.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Gender = 'M',
                            HireDate = new DateTime(2022, 5, 26, 9, 42, 20, 396, DateTimeKind.Utc).AddTicks(8070),
                            Name = "Artur",
            ...
            modelBuilder.Entity("MASAPI.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Accepted = new DateTime(2022, 5, 26, 9, 42, 20, 396, DateTimeKind.Utc).AddTicks(9660),
                            Gender = 'M',
                            IdHospital = 1,
                            Name = "Piotrek",
                        ...
                        {
                            ID = 2,
                            Accepted = new DateTime(2022, 5, 26, 9, 42, 20, 396, DateTimeKind.Utc).AddTicks(9670),
                            Gender = 'F',
                            IdHospital = 2,
                            Name = "Angelika",
